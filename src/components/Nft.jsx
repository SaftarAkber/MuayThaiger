...
const Nft = () => {
  return (
    <div id='nft' className='bg-[url("/src/bgnft.png")] w-full bg-cover h-screen grid-cols-2 md:grid'>
      <div className='grid-cols-1 items-center flex justify-center md:w-[100%] '>
        ...
        >
          <SwiperSlide className='  flex justify-center mx-auto'>
            <img src="/public/images/slidertiger1.png" alt="" />
          </SwiperSlide>
          <SwiperSlide className=' flex justify-center mx-auto'>
            <img src="/images/slidertiger2.png" alt="" />
          </SwiperSlide>
          <SwiperSlide className='  flex justify-center mx-auto'>
            <img src="/images/slidertiger1.png" alt="" />
          </SwiperSlide>
          <SwiperSlide className=' flex justify-center mx-auto'>
            <img src="/images/slidertiger2.png" alt="" />
          </SwiperSlide>
        ...
        <div className='px-6 text-orange-500 text-xl'>
          ...
          <div className='grid gap-4 grid-cols-2 my-3.5'>
            <div className="relative group inline-block leading-none text-gray-200 border border-gray-800 rounded-lg focus:outline-none focus:shadow-outline bg-gradient-to-b hover:from-indigo-500 from-gray-900 to-black">
              <div className=" h-[70px] w-[100%] justify-center text-center flex items-center text-white px-4 py-2 rounded-lg  ">Common</div>
            ...
            <div className="relative group inline-block leading-none text-gray-200 border border-gray-800 rounded-lg focus:outline-none focus:shadow-outline bg-gradient-to-b hover:from-indigo-500 from-gray-900 to-black">
              <div className=" h-[70px] w-[100%] justify-center text-center flex items-center text-white px-4 py-2 rounded-lg hover: ">UnCommon</div>
              <div className="opacity-0 invisible group-hover:opacity-100 group-hover:visible absolute w-48 mt-2 bg-white text-gray-800 border border-gray-300 rounded-lg shadow-lg py-2 z-10">
                <p className="px-4 py-2">This is a popover component.</p>
                <p className="px-4 py-2">You can customize it with your content.</p>
              </div>
            ...
            <div className="relative group inline-block leading-none text-gray-200 border border-gray-800 rounded-lg focus:outline-none focus:shadow-outline bg-gradient-to-b hover:from-indigo-500 from-gray-900 to-black">
              <div className=" h-[70px] w-[100%] justify-center text-center flex items-center text-white px-4 py-2 rounded-lg hover: ">Rare</div>
              <div className="opacity-0 invisible group-hover:opacity-100 group-hover:visible absolute w-48 mt-2 bg-white text-gray-800 border border-gray-300 rounded-lg shadow-lg py-2 z-10">
                <p className="px-4 py-2">Default content</p>
                <p className="px-4 py-2">Lorem content text here.</p>
              </div>
            </div>
            <div className="relative group inline-block leading-none text-gray-200 border border-gray-800 rounded-lg focus:outline-none focus:shadow-outline bg-gradient-to-b hover:from-indigo-500 from-gray-900 to-black">
              <div className=" h-[70px] w-[100%] justify-center text-center flex items-center text-white px-4 py-2 rounded-lg hover: ">Epic</div>
              <div className="opacity-0 invisible group-hover:opacity-100 group-hover:visible absolute w-48 mt-2 bg-white text-gray-800 border border-gray-300 rounded-lg shadow-lg py-2 z-10">
                <p className="px-4 py-2">This is a popover component.</p>
                <p className="px-4 py-2">You can customize it with your content.</p>
              </div>
