function Newsletter() {
    return (
        <div className="relative isolate overflow-hidden bg-[#1e2a21] px-6 py-24 shadow-2xl  sm:px-24 xl:py-32">
            <h2 className="mx-auto max-w-2xl text-center text-3xl font-bold tracking-tight text-white sm:text-4xl">FOLLOW FOR UPDATES</h2>
            <p className="mx-auto mt-2 max-w-xl text-center text-lg leading-8 text-gray-300">
                Bizden alin razi qalin
            </p>
            <form className="mx-auto mt-10 flex max-w-md gap-x-4">
                ...
                <button type="submit" className="flex-none rounded-md bg-white px-3.5 py-2.5 text-sm font-semibold text-gray-900 shadow-sm hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">Subscribe me</button>
            </form>
